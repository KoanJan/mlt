...
func main() {
	...
	// }
	data := []lib.Vector{
		lib.NewVectorFloat64([]float64{0, 2, 1, 1}),
		lib.NewVectorFloat64([]float64{1, 0, 2, 2}),
		lib.NewVectorFloat64([]float64{2, 1, 0, 3}),
	}
	// log.Printf("%v\n", data)
	log.Printf("%v\n", lib.MedianFloat64(data, 0))
	// log.Printf("%v\n", data)
	log.Printf("%v\n", lib.MedianFloat64(data, 1))
	// log.Printf("%v\n", data)
	log.Printf("%v\n", lib.MedianFloat64(data, 2))
	// log.Printf("%v\n", data)
}
